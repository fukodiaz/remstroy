		...
		<ul class="listFooterMenu">
			...
			foreach($arResult as $arItem):?>
				...
				<?else:?>
						...
						<?if ($arItem["DEPTH_LEVEL"] == 1):?>
							<li class="<?php if ($arItem["SELECTED"]) echo "itemLinkFooterMenu active"; else echo "itemLinkFooterMenu"?>">
								<a href="<?=$arItem["LINK"]?>" <?php if ($arItem["SELECTED"]) echo 'class="active"';?>><?=$arItem["TEXT"]?></a></li>
						<?else:?>
